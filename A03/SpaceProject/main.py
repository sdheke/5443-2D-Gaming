...
class BasicPlayer:
    def __init__(self, screen):
        ...
        self.image = pygame.image.load("sprites/space_ship7.png")
        self.rect = self.image.get_rect()
        self.position = pygame.math.Vector2(randint(25, 400), randint(25, 400))
        self.speed = 1
    ...
    def callBack(self, ch, method, properties, body):
        ...
        if not sender in self.players:
            ...
            if pygame.time.get_ticks() - self.players[sender].lastUpdated > 100:
                self.players[sender].position.x = x
                self.players[sender].position.y = y
